...
import LineChartAnalyticBase, { LineChartAnaltyicalBaseProps } from './LineChartAnalyticBase';

export default class TCE extends React.Component<any, any>{
    ...
    getData(props: LineChartAnaltyicalBaseProps, baseCtrl: LineChartAnalyticBase, ctrl: TCE): void {
        ...
        var frequencyDataHandle = this.openSEEService.getFrequencyData(props.eventId, props.pixels, "TripCoilCurrent", props.startDate, props.endDate).then(data => {
            if (data == null) return;
