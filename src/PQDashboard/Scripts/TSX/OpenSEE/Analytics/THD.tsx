...
export default function THD(props: LineChartAnaltyicalBaseProps): JSX.Element {
    ...
    return createElement(LineChartAnalyticBase, {
        ...
        legendKey: "THD",
        openSEEServiceFunction: (eventid, pixels, startDate, endDate) => openSEEService.getTHDData(eventid, pixels, startDate, endDate),
