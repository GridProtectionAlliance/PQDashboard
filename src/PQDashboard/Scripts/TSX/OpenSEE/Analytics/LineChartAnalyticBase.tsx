...
export default class LineChartAnalyticBase extends React.Component<any, any>{
    ...
    props: {
        ...
        tableUpdater: Function, postedData: iPostedData, tableSetter: Function, legendKey: string, openSEEServiceFunction: Function, legendEnable: Function, legendDisplay: Function,
        getColor? : Function
    }
    ...
    constructor(props, context) {
        ...
        if (ctrl.props.getColor != undefined) ctrl.getColor = (label) => ctrl.props.getColor(label);
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        delete props.tableUpdater;
        delete nextPropsClone.tableUpdater;
    ...
    createLegendRows(data) {
        ...
        $.each(data, function (i, key) {
            ...
            if (record == undefined)
                legend.set(key.ChartLabel, { color: ctrl.getColor(key), display: ctrl.props.legendDisplay(key.ChartLabel), enabled: ctrl.props.legendEnable(key.ChartLabel), data: key.DataPoints });
            else
