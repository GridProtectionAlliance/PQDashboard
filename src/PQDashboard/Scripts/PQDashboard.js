...
var EventSearchList = function (props) {
    var _a = React.useState("FileStartTime"), sortField = _a[0], setSortField = _a[1];
    ...
    React.useEffect(function () {
        pqDashboardService.getEventSearchData().done(function (results) {
    ...
    return (React.createElement(Table_1.default, { cols: [
        ...
        }, onClick: function (item) { return props.stateSetter({ eventid: item.row.EventID }); }, theadStyle: { fontSize: 'smaller' }, selected: function (item) {
            if (item.EventID == props.eventid)
                return true;
            else
                return false;
        } }));
};
var EventPreviewPane = function (props) {
    return (React.createElement("div", null, props.eventid));
};
