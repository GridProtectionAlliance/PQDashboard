<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MeterDisturbancesByLine.aspx.cs" Inherits="MeterDisturbancesByLine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./Scripts/MeterDisturbancesByLine.js"></script>
	</head>
    ...
    <div class="gridheader"><center>Disturbances for <%=postedMeterName%> for <%=postedDate%></center></div>
