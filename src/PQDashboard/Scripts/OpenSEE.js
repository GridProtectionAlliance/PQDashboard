...
function HighPassFilter(props) {
    ...
    return react_1.createElement(LineChartAnalyticBase_1.default, {
        ...
        openSEEServiceFunction: function (eventid, pixels, startDate, endDate) { return openSEEService.getHighPassFilterData(eventid, pixels, startDate, endDate); },
        endDate: props.endDate,
        eventId: props.eventId,
        height: props.height,
        hover: props.hover,
...
function LowPassFilter(props) {
    ...
    return react_1.createElement(LineChartAnalyticBase_1.default, {
        ...
        openSEEServiceFunction: function (eventid, pixels, startDate, endDate) { return openSEEService.getLowPassFilterData(eventid, pixels, startDate, endDate); },
        endDate: props.endDate,
        eventId: props.eventId,
        height: props.height,
        hover: props.hover,
...
function Retifier(props) {
    ...
    return react_1.createElement(LineChartAnalyticBase_1.default, {
        ...
        legendEnable: function (key) { return key.indexOf("V") == 0; },
        legendKey: "Rectifier",
        openSEEServiceFunction: function (eventid, pixels, startDate, endDate) { return openSEEService.getRectifierData(eventid, pixels, startDate, endDate); },
        endDate: props.endDate,
                ...
                React.createElement("ul", { className: "navbar-nav mr-auto", style: { width: '100%' } },
                    React.createElement("li", { className: "nav-item dropdown", style: { width: '150px' } },
                        ...
                        React.createElement("div", { className: "dropdown-menu", "aria-labelledby": "navbarDropdown" },
                            ...
                            React.createElement("a", { className: "dropdown-item", onClick: this.exportComtrade.bind(this) }, "Export COMTRADE"))),
                    ...
                    React.createElement("li", { className: "nav-item", style: { width: '193px' } },
                        React.createElement("div", { className: "input-group mb-3" },
                            React.createElement("div", { className: "input-group-prepend" },
                                ...
                                (this.props.selected == "meter" ? React.createElement("a", { href: (this.props.nextBackLookup.Meter.m_Item != null ? "?eventid=" + this.props.nextBackLookup.Meter.m_Item.ID + "&navigation=meter" : '#'), id: "meter-back", key: "meter-back", className: 'btn btn-primary' + (this.props.nextBackLookup.Meter.m_Item1 == null ? ' disabled' : ''), title: (this.props.nextBackLookup.Meter.m_Item1 != null ? this.props.nextBackLookup.Meter.m_Item1.StartTime : ''), style: { padding: '4px 20px' } }, "<") : null),
...
var LineChartAnalyticBase = (function (_super) {
    ...
    LineChartAnalyticBase.prototype.createDataRows = function (data, legend) {
        ...
        if ($('#tooltipwithdelta').css('display') != 'none') {
            this.props.tooltipWithDeltaTable.forEach(function (value, key, map) { return _this.options['grid'].markings.push(_this.highlightCycleForDelta(_this.getMillisecondTime(key))); });
        }
        this.plot = $.plot($(ctrl.refs.graphWindow), newVessel, this.options);
        this.plotSelected();
        this.plotZoom();
        ...
        return (React.createElement("div", { style: { position: 'absolute', width: '100%', height: '100%', overflow: 'hidden' } },
            ...
            React.createElement("div", { style: { width: 'calc(100% - 300px)', height: 'inherit', position: 'relative', float: 'right' } },
                ...
                React.createElement("div", { style: { padding: '0', height: "calc(100% - 62px)", overflowY: 'auto' } },
                    ...
                    (this.state.tab == "Analytics" && this.state.analytic == "LowPassFilter" ? React.createElement(LowPassFilter_1.default, { eventId: this.state.eventid, startDate: this.state.StartDate, endDate: this.state.EndDate, pixels: this.state.Width, stateSetter: this.stateSetter.bind(this), height: height, hover: this.state.Hover, tableData: this.TableData, pointsTable: this.state.PointsTable, postedData: this.state.PostedData, tableSetter: this.tableUpdater.bind(this), tooltipWithDeltaTable: this.state.TooltipWithDeltaTable }) : null),
                    (this.state.tab == "Analytics" && this.state.analytic == "HighPassFilter" ? React.createElement(HighPassFilter_1.default, { eventId: this.state.eventid, startDate: this.state.StartDate, endDate: this.state.EndDate, pixels: this.state.Width, stateSetter: this.stateSetter.bind(this), height: height, hover: this.state.Hover, tableData: this.TableData, pointsTable: this.state.PointsTable, postedData: this.state.PostedData, tableSetter: this.tableUpdater.bind(this), tooltipWithDeltaTable: this.state.TooltipWithDeltaTable }) : null),
                    ...
                    (this.state.tab == "Analytics" && this.state.analytic == "Rectifier" ? React.createElement(Rectifier_1.default, { eventId: this.state.eventid, startDate: this.state.StartDate, endDate: this.state.EndDate, pixels: this.state.Width, stateSetter: this.stateSetter.bind(this), height: height, hover: this.state.Hover, tableData: this.TableData, pointsTable: this.state.PointsTable, postedData: this.state.PostedData, tableSetter: this.tableUpdater.bind(this), tooltipWithDeltaTable: this.state.TooltipWithDeltaTable }) : null),
