<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MeterEventsByLine.aspx.cs" Inherits="MeterEventsByLine" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="./js/MeterEventsByLine.js"></script>
