...
(function ($) {
    ...
    $.fn.mobileSelect.defaults = {
        ...
        templateFilterable:'<div><div class="mobileSelect-title"><div class="right-inner-addon"><input class="form-control mobileSelect-filter" placeholder="Search"/></div></div><div class="list-container"></div><div class="mobileSelect-buttons"><a href="#" class="mobileSelect-selectallbtn"></a><a href="#" class="mobileSelect-savebtn"></a><a href="#" class="mobileSelect-clearbtn"></a><a href="#" class="mobileSelect-cancelbtn"></a></div></div>',
