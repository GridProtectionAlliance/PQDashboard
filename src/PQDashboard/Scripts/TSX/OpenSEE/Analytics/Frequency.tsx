...
export default function Frequency (props: LineChartAnaltyicalBaseProps): JSX.Element{
    ...
    return createElement(LineChartAnalyticBase, {
        ...
        legendKey: "Frequency",
        openSEEServiceFunction: (eventid, pixels, startDate, endDate) => openSEEService.getFrequencyAnalyticData(eventid, pixels, startDate, endDate),
