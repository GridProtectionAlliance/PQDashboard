//******************************************************************************************************
//  MinimumSagsHeatmapController.cs - Gbtc
//
...
namespace PQDashboard.Controllers.Events.MinimumSags
{
    ...
    [RoutePrefix("api/Events/MinimumSags")]
    public class MinimumSagsHeatmapController: ApiController
    {
        [Route(""), HttpPost]
