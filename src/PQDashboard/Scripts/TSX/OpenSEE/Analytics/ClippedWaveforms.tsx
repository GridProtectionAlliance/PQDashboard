...
export default function ClippedWaveforms (props: LineChartAnaltyicalBaseProps):JSX.Element {
    ...
    return createElement(LineChartAnalyticBase, {
        ...
        openSEEServiceFunction: (eventid, pixels, startDate, endDate) => openSEEService.getClippedWaveformData(eventid, pixels, startDate, endDate),
